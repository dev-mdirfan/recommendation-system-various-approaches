'''
Content Based Recommendation System in class
Implementation of Content Based Recommendation System using TF-IDF and Cosine Similarity.
'''
...
class Recommend:
    '''
    This class is used to recommend products based on the product name.
    '''
    def __init__(self, title="Alisha Solid Women's Cycling Shorts") -> None:
        ...
        df.to_csv("./static/data/recommendData4.csv", index=False)
        # df.to_json ('./static/data/recommendData4.json')
        self.df = self.data
